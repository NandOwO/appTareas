...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("icons/mode/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("icons/mode/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("icons/mode/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("icons/mode/light.svg"));
        }
    }
